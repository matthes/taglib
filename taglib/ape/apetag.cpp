...
String APE::Tag::musicBrainzTrackId() const {
...
String APE::Tag::musicBrainzAlbumId() const {
...
String APE::Tag::musicBrainzArtistId() const {
...
String APE::Tag::acustidFingerprint() const {
...
void APE::Tag::setMusicBrainzTrackId(const String &s) {

}

void APE::Tag::setMusicBrainzAlbumId(const String &s) {

}

void APE::Tag::setMusicBrainzArtistId(const String &s) {

}

void APE::Tag::setAcustidFingerprint(const String &s) {
