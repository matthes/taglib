...
String ASF::Tag::musicBrainzTrackId() const {

	if(d->attributeListMap.contains("MusicBrainz/Track Id")) {

		return d->attributeListMap["MusicBrainz/Track Id"][0].toString();
	}

	return String::null;
}

String ASF::Tag::musicBrainzArtistId() const {

	if(d->attributeListMap.contains("MusicBrainz/Artist Id")) {

		return d->attributeListMap["MusicBrainz/Artist Id"][0].toString();
	}

	return String::null;
}

String ASF::Tag::musicBrainzAlbumId() const {

	if(d->attributeListMap.contains("MusicBrainz/Album Id")) {

		return d->attributeListMap["MusicBrainz/Album Id"][0].toString();
	}

	return String::null;
}

String ASF::Tag::acustidFingerprint() const {

	if(d->attributeListMap.contains("Acoustid/Fingerprint")) {

		return d->attributeListMap["Acoustid/Fingerprint"][0].toString();
	}

	return String::null;
}

void ASF::Tag::setMusicBrainzTrackId(const String &s) {

	setAttribute("MusicBrainz/Track Id", s);
}

void ASF::Tag::setMusicBrainzArtistId(const String &s) {

	setAttribute("MusicBrainz/Artist Id", s);
}

void ASF::Tag::setMusicBrainzAlbumId(const String &s) {

	setAttribute("MusicBrainz/Album Id", s);
}

void ASF::Tag::setAcustidFingerprint(const String &s) {

	setAttribute("Acoustid/Fingerprint", s);
}
