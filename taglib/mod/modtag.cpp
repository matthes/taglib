...
String Mod::Tag::musicBrainzTrackId() const {

	return String::null;
}

String Mod::Tag::musicBrainzArtistId() const {

	return String::null;
}

String Mod::Tag::musicBrainzAlbumId() const {

	return String::null;
}


String Mod::Tag::acustidFingerprint() const {

	return String::null;
}

void Mod::Tag::setMusicBrainzTrackId(const String &s) {

}

void Mod::Tag::setMusicBrainzArtistId(const String &s) {

}

void Mod::Tag::setMusicBrainzAlbumId(const String &s) {

}

void Mod::Tag::setAcustidFingerprint(const String &s) {
