...
MP4::Tag::parseFreeForm(MP4::Atom *atom, TagLib::File *file) {
	...
	if(data.size() > 2) {
		...
		if(type == TypeUTF8) {
            ...
            //std::cout << name << ":" << value.toString(String::null) << std::endl;
...
String MP4::Tag::musicBrainzTrackId() const {

	if(d->items.contains("----:com.apple.iTunes:MusicBrainz Track Id")) {

		return d->items["----:com.apple.iTunes:MusicBrainz Track Id"].toStringList().toString();
	}

	return String::null;
}

String MP4::Tag::musicBrainzArtistId() const {

	if(d->items.contains("----:com.apple.iTunes:MusicBrainz Artist Id")) {

		return d->items["----:com.apple.iTunes:MusicBrainz Artist Id"].toStringList().toString();
	}

	return String::null;
}

String MP4::Tag::musicBrainzAlbumId() const {

	if(d->items.contains("----:com.apple.iTunes:MusicBrainz Album Id")) {

		return d->items["----:com.apple.iTunes:MusicBrainz Album Id"].toStringList().toString();
	}

	return String::null;
}

String MP4::Tag::acustidFingerprint() const {

	if(d->items.contains("----:com.apple.iTunes:Acoustid Fingerprint")) {

		return d->items["----:com.apple.iTunes:Acoustid Fingerprint"].toStringList().toString();
	}

	return String::null;
}

void MP4::Tag::setMusicBrainzTrackId(const String &s) {

	d->items["----:com.apple.iTunes:MusicBrainz Track Id"] = StringList(s);
}

void MP4::Tag::setMusicBrainzArtistId(const String &s) {

	d->items["----:com.apple.iTunes:MusicBrainz Artist Id"] = StringList(s);
}

void MP4::Tag::setMusicBrainzAlbumId(const String &s) {

	d->items["----:com.apple.iTunes:MusicBrainz Album Id"] = StringList(s);
}

void MP4::Tag::setAcustidFingerprint(const String &s) {

	d->items["----:com.apple.iTunes:Acoustid Fingerprint"] = StringList(s);
}
