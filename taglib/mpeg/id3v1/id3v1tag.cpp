...
String ID3v1::Tag::musicBrainzTrackId() const {

	return String::null;
}

String ID3v1::Tag::musicBrainzArtistId() const {

	return String::null;
}

String ID3v1::Tag::musicBrainzAlbumId() const {

	return String::null;
}

String ID3v1::Tag::acustidFingerprint() const {

	return String::null;
}

void ID3v1::Tag::setMusicBrainzTrackId(const String &s) {

}

void ID3v1::Tag::setMusicBrainzArtistId(const String &s) {

}

void ID3v1::Tag::setMusicBrainzAlbumId(const String &s) {

}

void ID3v1::Tag::setAcustidFingerprint(const String &s) {
