 ...
 */
	   ...
	   */
	        ...
	        void setUserTextFrame(const ByteVector &id, const StringList &values);

	        void setUniqueFileIdentifierFrame(const String &ownerId, const String &ufId);

	        void removeUniqueFileIdentifierFrameWithOwner(const String &ownerId);
