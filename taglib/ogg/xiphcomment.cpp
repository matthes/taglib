...
String Ogg::XiphComment::musicBrainzTrackId() const {

	if(d->fieldListMap["MUSICBRAINZ_TRACKID"].isEmpty()) {
		return String::null;
	}
	return d->fieldListMap["MUSICBRAINZ_TRACKID"].front();
}

String Ogg::XiphComment::musicBrainzArtistId() const {

	if(d->fieldListMap["MUSICBRAINZ_ARTISTID"].isEmpty()) {
		return String::null;
	}
	return d->fieldListMap["MUSICBRAINZ_ARTISTID"].front();
}

String Ogg::XiphComment::musicBrainzAlbumId() const {

	if(d->fieldListMap["MUSICBRAINZ_ALBUMID"].isEmpty()) {
		return String::null;
	}
	return d->fieldListMap["MUSICBRAINZ_ALBUMID"].front();
}

String Ogg::XiphComment::acustidFingerprint() const {

	if(d->fieldListMap["ACOUSTID_FINGERPRINT"].isEmpty()) {
		return String::null;
	}
	return d->fieldListMap["ACOUSTID_FINGERPRINT"].front();
}

void Ogg::XiphComment::setMusicBrainzTrackId(const String &s) {

	addField("MUSICBRAINZ_TRACKID", s);
}

void Ogg::XiphComment::setMusicBrainzArtistId(const String &s) {

	addField("MUSICBRAINZ_ARTISTID", s, true);
}

void Ogg::XiphComment::setMusicBrainzAlbumId(const String &s) {

	addField("MUSICBRAINZ_ALBUMID", s, true);
}

void Ogg::XiphComment::setAcustidFingerprint(const String &s) {

	addField("ACOUSTID_FINGERPRINT", s, true);
}
