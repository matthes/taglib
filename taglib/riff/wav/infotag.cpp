...
String RIFF::Info::Tag::musicBrainzTrackId() const {

	return String::null;
}

String RIFF::Info::Tag::musicBrainzArtistId() const {

	return String::null;
}

String RIFF::Info::Tag::musicBrainzAlbumId() const {

	return String::null;
}

String RIFF::Info::Tag::acustidFingerprint() const {

	return String::null;
}

void RIFF::Info::Tag::setMusicBrainzTrackId(const String &s) {

}

void RIFF::Info::Tag::setMusicBrainzArtistId(const String &s) {

}

void RIFF::Info::Tag::setMusicBrainzAlbumId(const String &s) {

}

void RIFF::Info::Tag::setAcustidFingerprint(const String &s) {
