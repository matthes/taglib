...
PropertyMap Tag::properties() const {
	...
	if(!(musicBrainzTrackId().isNull())) {
		map["MUSICBRAINZ_TRACKID"].append(musicBrainzTrackId());
	}

	if(!(musicBrainzTrackId().isNull())) {
		map["MUSICBRAINZ_ALBUMID"].append(musicBrainzAlbumId());
	}

	if(!(musicBrainzTrackId().isNull())) {
		map["MUSICBRAINZ_ARTISTID"].append(musicBrainzArtistId());
	}

	if(!(acustidFingerprint().isNull())) {
		map["ACOUSTID_FINGERPRINT"].append(acustidFingerprint());
	}
...
PropertyMap Tag::setProperties(const PropertyMap &origProps) {
	...
	if(properties.contains("MUSICBRAINZ_ALBUMID")) {
		...
		setMusicBrainzTrackId(properties["MUSICBRAINZ_ALBUMID"].front());
		oneValueSet.append("MUSICBRAINZ_ALBUMID");
	}
	else {
		setMusicBrainzTrackId(String::null);
	}

	if(properties.contains("MUSICBRAINZ_ARTISTID")) {

		setMusicBrainzTrackId(properties["MUSICBRAINZ_ARTISTID"].front());
		oneValueSet.append("MUSICBRAINZ_ARTISTID");
	}
	else {
		setMusicBrainzTrackId(String::null);
	}
	...
	if(properties.contains("ACOUSTID_FINGERPRINT")) {

		setAcustidFingerprint(properties["ACOUSTID_FINGERPRINT"].front());
		oneValueSet.append("ACOUSTID_FINGERPRINT");
	}
	else {
		setAcustidFingerprint(String::null);
	}
