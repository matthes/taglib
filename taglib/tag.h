...
namespace TagLib {
   ...
   */
	 ...
	 */
	    ...
	    /*!
	* Returns identifier of the track in MusicBrainz service database;
	* If there is no MusicBrainz identifier set, returns 0.
	* return 0.
	*/
	    virtual String musicBrainzTrackId() const = 0;

	    /*!
	   * Returns identifier of the track's artist in MusicBrainz service database;
	   * If there is no MusicBrainz identifier set, returns 0.
	   * return 0.
	   */
	    virtual String musicBrainzArtistId() const = 0;

	    /*!
	   * Returns identifier of the track's album in MusicBrainz service database;
	   * If there is no MusicBrainz identifier set, returns 0.
	   * return 0.
	   */
	    virtual String musicBrainzAlbumId() const = 0;

	    /*!
	   * Returns track's fingerprint created by Acustid music fingerprinter;
	   * If there is no fingerprint set, returns 0.
	   * return 0.
	   */
	    virtual String acustidFingerprint() const = 0;
	 ...
	 */
	    ...
	    /*!
	   * Sets the track's MusicBrainz identifier to \a s.  If \a s is 0 then this value will be cleared.
	   */
	    virtual void setMusicBrainzTrackId(const String &s) = 0;

	    /*!
	   * Sets the track's artist MusicBrainz identifier to \a s.  If \a s is 0 then this value will be cleared.
	   */
	    virtual void setMusicBrainzArtistId(const String &s) = 0;

	    /*!
	   * Sets the track's album MusicBrainz identifier to \a s.  If \a s is 0 then this value will be cleared.
	   */
	    virtual void setMusicBrainzAlbumId(const String &s) = 0;

	    /*!
	   * Sets the track's fingerprint created by Acustid music fingerprinter to \a s.  If \a s is 0 then this value will be cleared.
	   */
	    virtual void setAcustidFingerprint(const String &s) = 0;
