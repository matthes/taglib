...
String TagUnion::musicBrainzTrackId() const {

	stringUnion(musicBrainzTrackId);
}

String TagUnion::musicBrainzArtistId() const {

	stringUnion(musicBrainzArtistId);
}

String TagUnion::musicBrainzAlbumId() const {

	stringUnion(musicBrainzAlbumId);
}

String TagUnion::acustidFingerprint() const {

	stringUnion(acustidFingerprint);
}

void TagUnion::setMusicBrainzTrackId(const String &s) {

	setUnion(MusicBrainzTrackId, s);
}

void TagUnion::setMusicBrainzArtistId(const String &s) {

	setUnion(MusicBrainzArtistId, s);
}

void TagUnion::setMusicBrainzAlbumId(const String &s) {

	setUnion(MusicBrainzAlbumId, s);
}

void TagUnion::setAcustidFingerprint(const String &s) {

	setUnion(AcustidFingerprint, s);
}
